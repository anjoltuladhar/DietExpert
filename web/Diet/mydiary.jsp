    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Food Details</h4><input type="number" id="measure" style="width:55px;" value="100" oninput="change()">
        </div>
	...
	<div style="overflow:auto;position:absolute;width:95%;height:65%;margin-left:5%;">
		<ol>
                    <%
                     ...
                     List<Food> f=ks.obtainRecommendedFoodNameForUserId("C:\\Users\\Anoor\\Documents\\NetBeansProjects\\DietManager\\src\\java\\com\\dietManager\\recommendation\\algorithmImpl\\test1.csv",(long)u_id,10);
                      for(Food rec:f)
                             {
                    %>
